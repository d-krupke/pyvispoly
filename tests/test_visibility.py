...
def test_contains():
    boundary = [Point(FieldNumber(0), FieldNumber(0)), Point(FieldNumber(0), FieldNumber(1)), Point(FieldNumber(1), FieldNumber(1)), Point(FieldNumber(1), FieldNumber(0))]
    ...
    assert vispoly.is_feasible_query_point(Point(FieldNumber(1.5), FieldNumber(0.5))) == False
    assert vispoly.is_feasible_query_point(Point(FieldNumber(0.5), FieldNumber(0.5))) == True
